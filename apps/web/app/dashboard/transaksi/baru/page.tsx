    ...
    <div style={{ minHeight: 300, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, fontFamily: 'DM Sans, system-ui, sans-serif' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <button onClick={() => window.location.reload()}
          style={{ padding: '8px 16px', background: SB, color: '#fff', border: 'none', borderRadius: 8, fontSize: 13, cursor: 'pointer', fontFamily: 'inherit' }}>
          Coba lagi
        </button>
      </div>
    </div>
      ...
      <div style={{ maxWidth: 620, margin: '0 auto', fontFamily: 'DM Sans, system-ui, sans-serif' }}>
        ...
        <div style={card}>
          ...
          {filteredCats.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '20px 0' }}>
              ...
              <p style={{ fontSize: 12.5, color: '#8B7E6E', marginBottom: 12 }}>
                Belum ada kategori {isIncome ? 'pemasukan' : 'pengeluaran'}.
              </p>
              <a href="/dashboard/kategori" style={{ fontSize: 12, color: SB, textDecoration: 'none', fontWeight: 500 }}>
        ...
        <div style={card}>
          ...
          <div>
            ...
            <div onClick={() => fileRef.current?.click()}
              onMouseEnter={() => setHoverFile(true)} onMouseLeave={() => setHoverFile(false)}
        ...
        <div style={{ display: 'flex', gap: 9, marginBottom: 32 }}>
          <button onClick={() => router.back()}
            onMouseEnter={() => setHoverCancel(true)} onMouseLeave={() => setHoverCancel(false)}
